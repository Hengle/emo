...
namespace XLua.CSObjectWrap
{
    ...
    public class libxSceneAssetAsyncRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(libx.SceneAssetAsyncRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3))
				{
					...
					libx.SceneAssetAsyncRequest gen_ret = new libx.SceneAssetAsyncRequest(_path, _addictive);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to libx.SceneAssetAsyncRequest constructor!");
        ...
        static int _g_get_progress(RealStatePtr L)
        {
		    try {
                ...
                libx.SceneAssetAsyncRequest gen_to_be_invoked = (libx.SceneAssetAsyncRequest)translator.FastGetCSObj(L, 1);
